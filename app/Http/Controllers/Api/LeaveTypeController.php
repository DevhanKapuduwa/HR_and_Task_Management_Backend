...
class LeaveTypeController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $request->validate([
            ...
            'is_active' => 'boolean',
            'approval_chain_roles' => 'required|array|min:1',
            'approval_chain_roles.*' => 'required|string|in:supervisor,hr,management',
        ...
        $lt = LeaveType::create([
            ...
            'approval_chain_roles' => $request->approval_chain_roles,
    ...
    public function update(Request $request, LeaveType $leaveType): JsonResponse
    {
        $request->validate([
            ...
            'requires_attachment' => 'boolean',
            'is_active' => 'boolean',
            'approval_chain_roles' => 'sometimes|array|min:1',
            'approval_chain_roles.*' => 'required|string|in:supervisor,hr,management',
        ...
        $leaveType->update([
            ...
            'approval_chain_roles' => $request->approval_chain_roles ?? $leaveType->approval_chain_roles,
